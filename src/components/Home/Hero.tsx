    ...
    <header className="flex flex-col text-center leading-9 md:leading-normal md:text-left md:flex-row md:h-screen overflow-clip">
      <div className="order-2 md:order-1 space-y-5">
        ...
        <p className="text-body mt-2">
          ...
          well-being? <b>You&apos;re not alone</b>. Our mission is to shed light
          on the silent mental struggles of Jamaican university students. Join
          us in breaking the stigma and discovering the support you deserve.
          Take our depression test, explore mental health resources, and take
          the first step towards a brighter and more balanced campus life.
        </p>
      ...
      <img
        src={hero}
        className="order-1 md:order-2 self-center w-[200px] md:w-[400px] lg:w-[500px] md:self-start"
        alt="girl meditating"
      />
    </header>
  );
