      ...
      >
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            {submitted ? (
              <ResultsModal
                heading={`Result: ${determineDepressionLevel(
                  calculateScore(),
                )}`}
                body={`The PHQ-9 depression screening tool on this website provides informational guidance only and is not a substitute for professional diagnosis or treatment. Its results should not be considered a definitive assessment; please consult a qualified healthcare professional for an accurate evaluation of your mental health.
              Based on your responses you received a total score of ${calculateScore()}.`}
              />
            ) : (
              <button
                type="submit"
